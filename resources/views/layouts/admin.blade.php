...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg">Aplikasi<b>Penjualan</b></span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{asset('images/ruanglesonline_teacher3.png')}}" class="user-image" alt="User Image">
              <span class="hidden-xs">Admin Penjualan</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="{{asset('images/ruanglesonline_teacher3.png')}}" class="img-circle" alt="User Image">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="{{url('admin/barang')}}"><i class="fa fa-archive"></i> <span>Barang</span></a></li>
        <li><a href="{{url('admin/petugas')}}"><i class="fa fa-user"></i><span>Petugas</span></a></li>
        <li><a href="{{url('admin/distributor')}}"><i class="fa fa-users"></i> <span>Distributor</span></a></li>
        <li><a href="{{url('admin/jenis')}}"><i class="fa fa-filter"></i> <span>Jenis</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
